...
export default function AllocationReplayRenderer({ allocation }: { allocation: any[] }) {
  ...
  return (
    <div className="timeline-container">
      <h3 className="aura-heading">🔁 Allocation Replay</h3>
      <p className="aura-text">Replaying historical ATS allocation event.</p>
