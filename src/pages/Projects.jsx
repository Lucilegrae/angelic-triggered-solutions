    ...
    <ErrorBoundary>
      ...
      >
        ...
        >
          ...
          />
          <GlyphCard
            title="Small-Scale Miners Capacitation"
            description="Supporting artisanal miners through training, equipment access, and covenantal empowerment to enhance productivity and safety."
            sound="/chime.mp3"
          />
          <GlyphCard
            title="Artisanal Mining Formalization"
            description="Formalizing artisanal mining with bankable structuring, ensuring sustainable extraction anchored in communal affirmation and covenantal stewardship."
            sound="/chime.mp3"
          />
          <GlyphCard
        ...
        <p
          ...
          style={{ marginTop: "3rem", fontSize: "14px", opacity: "0.85" }}
        >
