    ...
    for (let currentModule = module;;) {
        if (!configArrayFactoryPath) {
            ...
            try {
                ...
                const resolvedConfigArrayFactoryPath = path.join(eslintrcFolder, '/lib/config-array-factory.jsx');
            ...
            try {
                ...
                if (path.join(eslintCandidateFolder, 'lib/cli-engine/cli-engine.jsx') === currentModule.filename) {
                    eslintFolder = eslintCandidateFolder;
                    break;
                }
            }
