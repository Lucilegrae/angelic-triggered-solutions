...
import {
    ...
    IgnorePattern,
    OverrideTester
} from "./config-array/index.jsx";
import ConfigValidator from "./shared/config-validator.jsx";
import * as naming from "./shared/naming.jsx";
import * as ModuleResolver from "./shared/relative-module-resolver.jsx";
...
class ConfigArrayFactory {
    ...
    *_normalizeObjectConfigDataBody(
    ...
    _loadExtendedShareableConfig(extendName, ctx) {
        ...
        const relativeTo = ctx.filePath || path.join(cwd, "__placeholder__.jsx");
        let request;
    ...
    _loadPlugin(name, ctx) {
        ...
        const relativeTo = path.join(ctx.pluginBasePath, "__placeholder__.jsx");
