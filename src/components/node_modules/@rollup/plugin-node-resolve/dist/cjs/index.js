...
function getPackageInfo(options) {
  ...
  if (
    ...
    packageInfo.resolvedEntryPoint = path.resolve(pkgRoot, pkg.main || 'index.jsx');
...
const ES6_BROWSER_EMPTY = '\0node-resolve:empty.jsx';
...
function nodeResolve(opts = {}) {
  ...
  return {
    ...
    async resolveId(importee, importer, opts) {
      ...
      // TypeScript files may import '.jsx' to refer to either '.ts' or '.tsx'
      if (importer && importee.endsWith('.jsx')) {
