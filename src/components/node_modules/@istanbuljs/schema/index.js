...
const defaultExclude = require('./default-exclude.jsx');
const defaultExtension = require('./default-extension.jsx');
...
const testExclude = {
	...
	extension: {
		description: 'a list of extensions that nyc should handle in addition to .jsx',
		type: 'array',
		items: {
			type: 'string'
		},
