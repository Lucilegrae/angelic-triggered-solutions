...
var _importMetaResolve = require("../../vendor/import-meta-resolve.jsx");
require("module");
function _fs() {
...
function resolveStandardizedNameForImport(type, name, dirname) {
  const parentUrl = (0, _url().pathToFileURL)(_path().join(dirname, "./babel-virtual-resolve-base.jsx")).href;
  const it = resolveAlternativesHelper(type, name);
  let res = it.next();
  while (!res.done) {
